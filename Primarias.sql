...
ALTER TABLE premiosMultimedia ADD CONSTRAINT PK_premiosMu PRIMARY KEY (idMultimedia);
ALTER TABLE premiosM ADD CONSTRAINT PK_premiosM PRIMARY KEY (id);
ALTER TABLE categoriasMultimedias ADD CONSTRAINT PK_categoriasM PRIMARY KEY(idCategoria,idMultimedia);
ALTER TABLE series ADD CONSTRAINT PK_series PRIMARY KEY (id);
ALTER TABLE temporadas ADD CONSTRAINT PK_temporadas PRIMARY KEY (id,idSerie);
ALTER TABLE infoTemporadas ADD CONSTRAINT PK_infoTem PRIMARY KEY (idTemporadas);
ALTER TABLE capitulosSeries ADD CONSTRAINT PK_capitulosS PRIMARY KEY (id,idTemporadas);
ALTER TABLE infoCapitulosSeries ADD CONSTRAINT PK_infoCapS PRIMARY KEY (id);
...
ALTER TABLE infoCapitulosDocumentales ADD CONSTRAINT PK_infoCapDo PRIMARY KEY (id);
...
ALTER TABLE premiosA ADD CONSTRAINT PK_premiosA PRIMARY KEY (id);
